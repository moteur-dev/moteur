...
vi.mock('@moteur/core/webhooks/webhookService.js', () => ({
    listWebhooks: vi.fn(),
    getWebhook: vi.fn(),
    createWebhook: vi.fn(),
    updateWebhook: vi.fn(),
...
import adminWebhooksRouter from '../../src/admin/webhooks/index.js';
import {
    listWebhooks,
    getWebhook,
    createWebhook,
...
app.use('/admin/projects/:projectId/webhooks', adminWebhooksRouter);

const base = '/admin/projects/demo/webhooks';
