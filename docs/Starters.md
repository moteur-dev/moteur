...
```bash
git clone https://github.com/moteur-dev/moteur-starter-next
```
...
```bash
git clone https://github.com/moteur-dev/moteur-starter-astro
```
...
```bash
git clone https://github.com/moteur-dev/moteur-starter-eleventy
```
...
```bash
git clone https://github.com/moteur-dev/moteur-starter-slim
```
...
```bash
git clone https://github.com/moteur-dev/moteur-starter-cloudflare
```
...
```bash
git clone https://github.com/moteur-dev/moteur-starter-nuxt
```
...
**I'm a Vue developer** → `moteur-starter-nuxt`# Starters
