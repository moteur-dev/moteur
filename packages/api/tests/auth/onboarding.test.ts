...
vi.mock('@moteur/core/emailNotifier', () => ({
...
vi.mock('@moteur/core/utils/fileUtils', () => ({
    isExistingProjectId: vi.fn().mockReturnValue(true)
}));

import { runOnboardingForNewUser } from '../../src/auth/onboarding';
import { sendWelcomeEmail } from '@moteur/core/emailNotifier';
import { getDemoProjectId, copyProjectForNewUser } from '@moteur/core/projects';
import { isExistingProjectId } from '@moteur/core/utils/fileUtils';
