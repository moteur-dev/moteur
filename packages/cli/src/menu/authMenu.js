...
var auth_1 = require("@moteur/core/auth");
var fs_1 = require("fs");
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 5];
                case 2: return [4 /*yield*/, handleLogin()];
                case 3:
                    _b.sent();
                    return [3 /*break*/, 6];
                case 4:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, auth_1.loginUser)(email, password)];
                case 3:
                    token = _b.sent();
                    fs_1.default.writeFileSync(TOKEN_FILE, JSON.stringify({ token: token }, null, 2));
                    console.log("\n\u2705 Logged in as ".concat(email));
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _b.sent();
                    console.log('\n❌ Login failed:', err_1 instanceof Error ? err_1.message : String(err_1));
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
