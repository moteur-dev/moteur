...
import { sendWelcomeEmail } from '@moteur/core/emailNotifier.js';
import { getDemoProjectId, copyProjectForNewUser } from '@moteur/core/projects.js';
import { isExistingProjectId } from '@moteur/core/utils/fileUtils.js';
