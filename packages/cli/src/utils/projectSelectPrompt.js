...
exports.projectSelectPrompt = projectSelectPrompt;
var inquirer_1 = require("inquirer");
var projects_1 = require("@moteur/core/projects");
function projectSelectPrompt(user) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, inquirer_1.default.prompt({
                            ...
                            choices: projects.map(function (p) { return ({ name: "".concat(p.label, " (").concat(p.id, ")"), value: p.id }); })
                        })];
                case 1:
                    selectedProject = (_a.sent()).selectedProject;
                    return [2 /*return*/, selectedProject];
            }
        });
    });
}
