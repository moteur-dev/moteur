...
import adminTemplatesRouter from '../../src/admin/templates/index.js';
import {
    listTemplates,
    getTemplateWithAuth,
    createTemplate,
...
app.use('/admin/projects/:projectId/templates', adminTemplatesRouter);

const base = '/admin/projects/demo/templates';
