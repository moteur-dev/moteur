...
export type Bucket = { admin: number; public: Record<string, number> };
...
export function recalculateFromContent(
    ...
    for (const line of lines) {
        ...
        if (entry.type !== 'admin' && entry.type !== 'public') continue;
